...
jasmine_util_1.describeWithFlags('debug on', jasmine_util_1.SYNC_BACKEND_ENVS, function () {
    ...
    it('debug mode errors when infinities in op output', function () { return __awaiter(_this, void 0, void 0, function () {
        var a, b, c;
        var _this = this;
    ...
    it('debug mode errors when nans in op output', function () { return __awaiter(_this, void 0, void 0, function () {
        var a, b, c;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
