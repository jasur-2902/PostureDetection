...
var MathBackendWebGL = /** @class */ (function (_super) {
        ...
        if (isImage || isVideo) {
            if (this.fromPixels2DContext == null) {
                ...
                this.fromPixels2DContext =
                    canvas_util_1.createCanvas(environment_1.env().getNumber('WEBGL_VERSION')).getContext('2d');
            }
    ...
    MathBackendWebGL.prototype.conv2dByMatMul = function (x, filter, convInfo, bias, activation, preluActivationWeights) {
        ...
        var xReshaped = this.reshape(x, [1, targetShape, convInfo.inChannels]);
    ...
    MathBackendWebGL.prototype.uploadToGPU = function (dataId) {
        ...
        if (values != null) {
            ...
            var encodedOutputTarget = this.runWebGLProgram(program, [tempDenseInputHandle], dtype);
