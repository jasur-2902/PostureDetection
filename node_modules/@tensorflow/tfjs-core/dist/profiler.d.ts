...
export declare class Profiler {
    ...
    profileKernel(kernelName: string, inputs: NamedTensorMap, f: () => Tensor[]): Tensor[];
}
...
export declare class Logger {
    logKernelProfile(name: string, result: Tensor, vals: TypedArray, timeMs: number, inputs: NamedTensorMap, extraInfo?: string): void;
}
