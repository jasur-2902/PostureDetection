...
function pad_(x, paddings, constantValue) {
    ...
    return engine_1.ENGINE.runKernelFunc(function (backend) { return backend.pad($x, paddings, constantValue); }, { $x: $x }, grad);
}
/**
...
function unstack_(x, axis) {
    ...
    return engine_1.ENGINE.runKernelFunc(function (backend) { return backend.unstack($x, axis); }, { $x: $x }, grad);
}
/**
