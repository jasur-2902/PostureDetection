...
jasmine_util_1.describeWithFlags('sign', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('does not propagate NaNs', function () { return __awaiter(_this, void 0, void 0, function () {
        var a, r, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
jasmine_util_1.describeWithFlags('erf', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('blowup', function () { return __awaiter(_this, void 0, void 0, function () {
        var values, a, result, expected, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    values = [-1.4, -2.5, -3.1, -4.4];
                    a = tf.tensor1d(values);
                    result = tf.erf(a);
                    expected = [-0.9522852, -0.999593, -0.9999883, -1];
                    _a = test_util_1.expectArraysClose;
                    return [4 /*yield*/, result.data()];
                case 1:
                    _a.apply(void 0, [_b.sent(), expected]);
