...
function resizeBilinear_(images, size, alignCorners) {
    ...
    var backward = function (dy, saved) {
        return {
            batchImages: function () { return engine_1.ENGINE.runKernelFunc(function (backend) { return backend.resizeBilinearBackprop(dy, saved[0], alignCorners); }, {}); }
        };
    };
...
function nonMaxSuppression_(boxes, scores, maxOutputSize, iouThreshold, scoreThreshold) {
    ...
    return engine_1.ENGINE.runKernelFunc(function (b) { return b.nonMaxSuppression($boxes, $scores, maxOutputSize, iouThreshold, scoreThreshold); }, { $boxes: $boxes });
}
...
function cropAndResize_(image, boxes, boxInd, cropSize, method, extrapolationValue) {
    ...
    var res = engine_1.ENGINE.runKernelFunc(forward, { $image: $image, $boxes: $boxes });
    return res;
}
