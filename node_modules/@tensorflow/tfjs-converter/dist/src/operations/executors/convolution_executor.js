...
exports.executeOp = function (node, tensorMap, context) {
    ...
    switch (node.op) {
        ...
        case '_FusedConv2D': {
            var extraOp = (_a = utils_1.getParamValue('fusedOps', node, tensorMap, context), _a[0]), activationFunc = _a[1];
            ...
            if (isBiasAdd) {
                if (isPrelu && numArgs !== 2) {
                    throw new Error('Fused Conv2d with BiasAdd and Prelu must have two ' +
            ...
            var dataFormat = utils_1.getParamValue('dataFormat', node, tensorMap, context)
                .toUpperCase();
            var dilations = utils_1.getParamValue('dilations', node, tensorMap, context);
            var biasArg = (_b = utils_1.getParamValue('args', node, tensorMap, context), _b[0]), preluArg = _b[1];
